...
require (
	...
	github.com/cloudwego/eino-ext/components/indexer/redis v0.0.0-20260409083444-42d9d11b55f4
	...
	github.com/cloudwego/eino-ext/components/retriever/redis v0.0.0-20260409083444-42d9d11b55f4
